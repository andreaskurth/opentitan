...
module pattgen_reg_top (
  ...
  logic ctrl_disabled_level_pda_ch0_qs;
  logic ctrl_disabled_level_pda_ch0_wd;
  logic ctrl_disabled_level_pcl_ch0_qs;
  logic ctrl_disabled_level_pcl_ch0_wd;
  logic ctrl_disabled_level_pda_ch1_qs;
  logic ctrl_disabled_level_pda_ch1_wd;
  logic ctrl_disabled_level_pcl_ch1_qs;
  logic ctrl_disabled_level_pcl_ch1_wd;
  logic prediv_ch0_we;
  ...
  //   F[disabled_level_pda_ch0]: 4:4
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_ctrl_disabled_level_pda_ch0 (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (ctrl_we),
    .wd     (ctrl_disabled_level_pda_ch0_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.ctrl.disabled_level_pda_ch0.q),
    .ds     (),

    // to register interface (read)
    .qs     (ctrl_disabled_level_pda_ch0_qs)
  );

  //   F[disabled_level_pcl_ch0]: 5:5
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_ctrl_disabled_level_pcl_ch0 (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (ctrl_we),
    .wd     (ctrl_disabled_level_pcl_ch0_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.ctrl.disabled_level_pcl_ch0.q),
    .ds     (),

    // to register interface (read)
    .qs     (ctrl_disabled_level_pcl_ch0_qs)
  );

  //   F[disabled_level_pda_ch1]: 6:6
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_ctrl_disabled_level_pda_ch1 (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (ctrl_we),
    .wd     (ctrl_disabled_level_pda_ch1_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.ctrl.disabled_level_pda_ch1.q),
    .ds     (),

    // to register interface (read)
    .qs     (ctrl_disabled_level_pda_ch1_qs)
  );

  //   F[disabled_level_pcl_ch1]: 7:7
  prim_subreg #(
    .DW      (1),
    .SwAccess(prim_subreg_pkg::SwAccessRW),
    .RESVAL  (1'h0),
    .Mubi    (1'b0)
  ) u_ctrl_disabled_level_pcl_ch1 (
    .clk_i   (clk_i),
    .rst_ni  (rst_ni),

    // from register interface
    .we     (ctrl_we),
    .wd     (ctrl_disabled_level_pcl_ch1_wd),
    ...
    // to internal hardware
    .qe     (),
    .q      (reg2hw.ctrl.disabled_level_pcl_ch1.q),
    .ds     (),

    // to register interface (read)
    .qs     (ctrl_disabled_level_pcl_ch1_qs)
  );
  ...
  assign ctrl_disabled_level_pda_ch0_wd = reg_wdata[4];

  assign ctrl_disabled_level_pcl_ch0_wd = reg_wdata[5];

  assign ctrl_disabled_level_pda_ch1_wd = reg_wdata[6];

  assign ctrl_disabled_level_pcl_ch1_wd = reg_wdata[7];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[4]: begin
        ...
        reg_rdata_next[4] = ctrl_disabled_level_pda_ch0_qs;
        reg_rdata_next[5] = ctrl_disabled_level_pcl_ch0_qs;
        reg_rdata_next[6] = ctrl_disabled_level_pda_ch1_qs;
        reg_rdata_next[7] = ctrl_disabled_level_pcl_ch1_qs;
      end
