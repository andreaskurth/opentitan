...
module hmac_reg_top (
  ...
  prim_subreg_ext #(
    ...
    .re     (1'b0),
    .we     (cmd_we),
    .wd     (cmd_hash_restart_wd),
    .d      ('0),
    .qre    (),
    .qe     (cmd_flds_we[3]),
    .q      (reg2hw.cmd.hash_restart.q),
    .ds     (),
    .qs     ()
  );
  assign reg2hw.cmd.hash_restart.qe = cmd_qe;
  ...
  assign cmd_hash_restart_wd = reg_wdata[3];
