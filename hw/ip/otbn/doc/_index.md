...
OTBN performs a secure wipe of the internal state after reset (*init*) and then becomes *idle*.
...
- If OTBN is securely wiping its internal state after reset, the {{< regref "STATUS" >}} register is set to `INIT_SEC_WIPE`.
